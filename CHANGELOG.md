...
- **1.2.0** (11/09/2026) Joining: name, @ebl.sg email, code from that mailbox; the admin taps Approve on WhatsApp; the PC collects its own key. No files handed around.
- **1.1.0** (10/09/2026) Automatic: syncs the working folder after every Claude turn and nightly; house rules at session start; personal or unclassified folders send one page only.
- **1.0.0** (10/09/2026) First version: `publish to EBL`, `ebl status`, `ebl list`, one-line installer, page and QR at ebl.sg/claude.
